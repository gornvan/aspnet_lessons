...
namespace lesson20_PerformanceTesting.Services
{
    /// <summary>
    /// Sample background service demonstrating how to publish metrics from background business logic.
    /// </summary>
    public class GoogleMicrosoftRaceService : BackgroundService
    {

        /// <summary>
        /// When we allocate HTTP clients, we mark them with this string to label the metrics generated by these HTTP clients.
        /// </summary>
        public const string HttpClientName = "GoogleMicrosoftRaceServiceHttpClient";

        public GoogleMicrosoftRaceService(IHttpClientFactory httpClientFactory)
        {
